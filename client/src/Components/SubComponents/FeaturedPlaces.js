    ...
    return (
        ...
        <div class="container-fluid">
            ...
            <div class="row portfolio-items">
                        ...
                        <div class="homes-content">
                            ...
                            <p class="homes-address mb-3">
                                <a href="single-property-1.html">
                                    <i class="fa fa-map-marker"></i><span>Nairobi -Parklands Safari Plaza</span>
                                </a>
                            </p>
                            ...
                            <span>Capitalizes on tastefully done nature infused indoors, free flow of natural...</span>
                            ...
                            <div class="price-properties footer pt-3 pb-0">
                                <h3 class="title mt-3">
                                 <a href="single-property-1.html">Ksh. 4000/hr</a>
                                </h3>
                                <div class="compare">
                ...
                </div><div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 landscapes sale">
                    <div class="project-single" >
                        <div class="project-inner project-head">
                            <div class="homes">
                                <a href="single-property-1.html" class="homes-img">
