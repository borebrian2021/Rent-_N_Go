                        ...
                        <div class="tr-single-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                              ...
                              <input
                                type="text"
                                class="form-control address mb-0"
                              />
                            </div>
                            <div class="col-sm-6">
                              <label>Zip</label>
                    ...
                    <div class="col-md-12 col-lg-6">
                      <div class="tr-single-box">
                        <div class="tr-single-body">
                          <div class="tr-single-header">
                            <h4>
                              <i class="far fa-credit-card pr-2"></i>Payment
                              Method
                            </h4>
                          </div>
                      ...
                      <div class="tr-single-body">
                        ...
                        <div class="booking-price-detail side-list no-border mb-3">
                          ...
                          <ul>
                            <li>
                              Date
                              <strong class="pull-right">18 Jun 2018</strong>
                            </li>
                            <li>
                            ...
                            <li>
                              From
                              <strong class="pull-right">10 jan 2019</strong>
                            </li>
                          </ul>
                        </div>
