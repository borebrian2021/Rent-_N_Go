...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference("Amenity.count") do
      post amenities_url, params: { amenity: { item_name: @amenity.item_name, price: @amenity.price, space_id: @amenity.space_id } }
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { item_name: @amenity.item_name, price: @amenity.price, space_id: @amenity.space_id } }
